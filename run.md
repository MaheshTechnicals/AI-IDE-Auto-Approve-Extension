...
### 1. Install ya Debug:
- **Kiro IDE me**: [kiro-auto-approve-0.3.0.vsix](file:///root/projects/AutoRun/kiro-auto-approve-0.3.0.vsix) install karein (`Extensions > ... > Install from VSIX...`) ya CLI se `kiro --install-extension kiro-auto-approve-0.3.0.vsix --force`.
- **Google Antigravity IDE me**: CLI se `antigravity --install-extension kiro-auto-approve-0.3.0.vsix --force` ya Extensions pane se install karein.
