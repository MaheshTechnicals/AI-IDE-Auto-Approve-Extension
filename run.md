...
### 1. Install ya Debug:
- **Permanent Install**: Kiro IDE me [kiro-auto-approve-0.2.2.vsix](file:///root/projects/AutoRun/kiro-auto-approve-0.2.2.vsix) install karein (`Extensions > ... > Install from VSIX...`).
